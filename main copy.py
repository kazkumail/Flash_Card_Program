...
unknown_button.config(bg=BACKGROUND_COLOR, highlightthickness=0, highlightbackground=BACKGROUND_COLOR,
...
check_button.config(bg=BACKGROUND_COLOR, highlightthickness=0, highlightbackground=BACKGROUND_COLOR,
                    highlightcolor=BACKGROUND_COLOR)
